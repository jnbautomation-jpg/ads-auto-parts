export function BrandLogo({ size = "sm" }: { size?: "sm" | "md" }) {
  ...
  return (
    <div className="flex items-center gap-2 lg:gap-2.5">
      <div className={`${bar} -skew-x-12 rounded-sm bg-[#E31E24]`} />
      <div className="flex flex-col items-center leading-none">
        <div className={`font-[family-name:var(--font-oswald)] font-bold tracking-[0.14em] ${text}`}>ADS</div>
        {size === "md" ? (
          <div className="mt-0.5 font-[family-name:var(--font-barlow-condensed)] text-[6.5px] font-semibold tracking-[0.28em] text-[#aaa] lg:text-[8px] lg:tracking-[0.3em]">
