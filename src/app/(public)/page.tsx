...
const TILES = [
  { name: "Doors", note: "Front & rear · shells & skins", slug: "doors", img: "/part-images/door.webp", alt: "Door" },
  { name: "Hoods", note: "Steel & aluminum", slug: "hoods", img: "/part-images/hood.webp", alt: "Hood" },
  { name: "Fenders", note: "Left & right", slug: "fenders", img: "/part-images/fender.webp", alt: "Fender" },
  { name: "Bumpers", note: "Covers & reinforcements", slug: "bumpers", img: "/part-images/bumper.webp", alt: "Bumper" },
  { name: "Tailgates & Trunks", note: "Trucks & sedans", slug: "tailgates-trunks", img: "/part-images/tailgate.webp", alt: "Tailgate" },
  ...
  { name: "Liftgates", note: "SUVs & hatchbacks", slug: "liftgates", img: "/part-images/tailgate.webp", alt: "Liftgate" },
  { name: "Quarter Panels", note: "Full & partial", slug: "quarter-panels", img: "/part-images/quarter-panel.webp", alt: "Quarter panel" },
  { name: "Rear Body Panels", note: "Rear body & valance", slug: "rear-body-panels", img: "/part-images/rear-body-panel.webp", alt: "Rear body panel" },
  { name: "Grilles", note: "Chrome & sport styles", slug: "grilles", img: "/part-images/grille.webp", alt: "Grille" },
  { name: "Hinges", note: "Door & hood hardware", slug: "hinges", img: "/part-images/hinge.webp", alt: "Hinge" },
  { name: "Radiator Supports", note: "Core support assemblies", slug: "radiator-support", img: "/part-images/radiator-support.webp", alt: "Radiator support" },
  { name: "Reinforcement Bars", note: "Bumper & body reinforcement", slug: "reinforcement-bars", img: "/part-images/reinforcement-bar.webp", alt: "Reinforcement bar" },
];
