...
export default async function EditProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const initialValues: ProductFormValues = {
    ...
    paintPrep: product.paintPrep ?? "",
    hasMirrorHole: product.hasMirrorHole === null ? "" : product.hasMirrorHole ? "yes" : "no",
    hasHandleHole: product.hasHandleHole === null ? "" : product.hasHandleHole ? "yes" : "no",
